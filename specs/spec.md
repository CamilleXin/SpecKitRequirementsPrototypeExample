...
本文档基于原型图“[![alt text](aa55ecd6b64d9140cda8431d3ffb4b4f.jpg.JPG)]”，按照 [spec-kit](https://github.com/github/spec-kit) 的规范，梳理产品需求，为后续设计与开发提供清晰标准。
...
| F-07 | 普惠进件审核 | 统计分析并展示  | [普惠进件审核] |
| F-08 | 超级智能体 | 统计分析并展示  | [超级智能体] |
| F-09 | 知识库 | 统计分析并展示  | [知识库] |
| F-10 | 证服指令识别 | 统计分析并展示  | [证服指令识别] |
| F-11 | REITs投研分析 | 统计分析并展示  | [REITs投研分析] |
...
(变更记录：在原稿基础上补充了“术语解释”、F-01 的详细指标定义、数据来源、计算细则、展示与权限要求，新增“依赖与假设”与“开放问题”章节，以便后续评审与开发实施。)
